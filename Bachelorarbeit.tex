...
%	\urgentnote[inline]{applications}
	...
	\begin{definition}[Category]
		...
		\begin{itemize}
			...
			\item For every pair of objects $A, B \in \Obj(\category{C})$ there is a class $\Hom(A, B)$ of \emph{morphisms} $f: A \rightarrow B$ from $A$ to $B$. We denote the class of all morphisms of $\category{C}$ with $\Morph{(\category{C}X)}$
