...
%	\urgentnote[inline]{applications}
	...
	We are often interested in the relation \notimportantnote{"relationship"?} between categories and how their structures can be translated into one another. Functors serve this purpose:
...
%---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	\begin{example}
		\begin{itemize}
			\item 
				Any monoidal category is a linearly distributive category with $\parr = \otimes$
			\item 
...
%__________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
	...
	That procedure can be extended to general linear logic \cite{brauner} and form the basis for further categorical models \cite{mellies}.
...
%	\todo[inline]{main source: IntroLinLog}
	...
	\begin{definition}[Sequent]
		A \emph{sequent} consists of two Lists $\Gamma$ and $\Delta$ combined by a turnstile $\vdash$. 
		Either $\Gamma$ or $\Delta$ may be empty. 
		While that turnstile serve a purely syntactic function, we will later see that it is correctly interpreted as an implication.
	\end{definition}
	...
	\begin{remark}
		...
		\begin{center}
			...
			\end{tikzpicture}
		\end{center}
		with $\surd$ marking the root. $\id$, $\otimes_R$ and $\otimes_L$ are sequent rules defined below. As this form is neither efficient nor pretty, we will stick with the traditional display.
	\end{remark}
