...
\begin{document}
	...
	\todo[inline]{move negation to other place?}
	...
	\todo[inline]{add "spoiler" to categoru theoru}
	\urgentnote[inline]{millies intLinLog cut elim. in classical  linlog übersetzen}
	
	\todo{add literature}
	We will adapt the cut-elimination procedure for intuitionistic linear logic by Melliès to (multiplicative) classical linear logic.
	\urgentnote{multiplicative or full?}
	
	\urgentnote[inline]{format that stuff into something more efficient: }
	
	\subsubsection{Commuting cuts}
	...
	\begin{tabularx}{\textwidth}{X c X}
		\scalebox{.7}{
			...
			\noLine
			\UnaryInfC{$\vdots$}
			\UnaryInfC{$A, \Gamma_2 \vdash \Delta_2, B $}
			...
			\RightLabel{Cut}
			\BinaryInfC{$A, \Gamma_2, \Gamma_3 \vdash \Delta_2, \Delta_3 $}
			
			\RightLabel{Cut}
			\BinaryInfC{$\Gamma_1, \Gamma_2, \Gamma_3 \vdash \Delta_1, \Delta_2, \Delta_3 $}
			\DisplayProof
		}
		&
		$\leftrightsquigarrow$
	...
	\todo[inline]{put all the stuff in such tables?}
	...
	\begin{center}
		...
		\RightLabel{Cut}
		\BinaryInfC{$\Gamma_1, \Gamma_2 \vdash \Delta_1, \Delta_2, B $}
	...
	\begin{center}
		...
		\noLine
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$\Gamma_2 \vdash \Delta_2, B $}
		
		\AxiomC{$\pi_3 $}
		\noLine
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$A, B, \Gamma_3 \vdash \Delta_3 $}
	...
	\urgentnote{Cut rule doesn't apply here...}
	...
	\begin{center}
		...
		\RightLabel{Cut}
		\BinaryInfC{$\Gamma_1, B, \Gamma_3 \vdash \Delta_1, \Delta_3 $}
		
		\RightLabel{Cut}
		\BinaryInfC{$\Gamma_1, \Gamma_2, \Gamma_3 \vdash \Delta_2, \Delta_1, \Delta_3 $}
		\DisplayProof
	\end{center}
	
	and vice versa
	\urgentnote[inline]{think about the deltas...}
	
	
%-------------------------------------------------------------------------------------------------------------------------------------
	\subsubsection{expansion steps }
	\todo[inline]{why are they called $\eta$-expansion steps? }
	...
	\begin{tabularx}{\textwidth}{x c x}
		...
		\DisplayProof
	\end{tabularx}
	\todo{format (page break)}

	
	
%---------------------------------------------------------------------------------------------------------------------
	\subsubsection{The axiom steps}
	...
	\todo[inline]{tabularx format...}
	
	
	\subsubsection{The exchange steps }
	
	\urgentnote[inline]{problem: that's not how Cut was defined...}
	...
	\begin{tabularx}{\textwidth}{x c x}
		...
		\noLine
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$A, B, \Gamma_2 \vdash \Delta_2 $}
		\RightLabel{ex.L}
		\UnaryInfC{$B, A, \Gamma_2 \vdash \Delta_2 $}
		
		\BinaryInfC{$B, \Gamma_1, \Gamma_2 \vdash \Delta_1, \Delta_2 $}
		\DisplayProof
		&
		$\rightsquigarrow$
		&
		...
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$A, B, \Gamma_2 \vdash \Delta_2 $}
		\BinaryInfC{$\Gamma_1, B, \Gamma_2 \vdash \Delta_1, \Delta_2 $}
		
		\doubleLine
		\RightLabel{ex.L}
		\UnaryInfC{$B, \Gamma_1, \Gamma_2 \vdash \Delta_1, \Delta_2 $}
		\DisplayProof
		...
		\noLine
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$\Gamma_1 \vdash \Delta_1, B $}
		...
		\BinaryInfC{$\Gamma_1, A, \Gamma_2 \vdash \Delta_1, \Delta_2 $}
		\DisplayProof
		&
		$\rightsquigarrow$
		&
		...
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$A, B, \Gamma_2 \vdash \Delta_2 $}
		\BinaryInfC{$A, \Gamma_1, \Gamma_2 \vdash \Delta_1, \Delta_2 $}
		
		\doubleLine
		\RightLabel{ex.L}
		\UnaryInfC{$\Gamma_1, A, \Gamma_2 \vdash \Delta_1, \Delta_2 $}
		\DisplayProof
	\end{tabularx}
	
	The double line signals multiple applications of the rule.
	
	
	\subsubsection{Principal formulae}
	...
	\begin{tabularx}{\textwidth}{x c x}
		...
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$A, B, \Gamma_3 \vdash \Delta_3$}
		\UnaryInfC{$A \otimes B, \Gamma_3 \vdash \Delta_3 $}
		...
		\scalebox{0.7}{			
			...
			\noLine
			\UnaryInfC{$\vdots$}
			\UnaryInfC{$\Gamma_1 \vdash \Delta_1, A, B $}
			\UnaryInfC{$\Gamma_1 \vdash \Delta_1, A \parr B $}
			...
			\noLine
			\UnaryInfC{$\vdots$}
			\UnaryInfC{$\Gamma_3, B \vdash \Delta_3 $}
		...
		\DisplayProof
	\end{tabularx}
	\urgentnote[inline]{Reihenfolge der Kontexte überdenken/ calculus detailierter definieren}
	...
	\begin{tabularx}{\textwidth}{x c x}
		%promotion vs derelection
		\AxiomC{$\pi_1$}
		\noLine
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$\oc\Gamma_1 \vdash \wn\Delta_1, A$}
		\RightLabel{$\oc_R$}
		\UnaryInfC{$\oc\Gamma_1\vdash \wn\Delta_1, \oc A $}
		
		\AxiomC{$\pi_2$}
		\noLine
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$A, \Gamma_2 \vdash \Delta_2$}
		\RightLabel{$\oc_D$}
		\UnaryInfC{$\oc A, \Gamma_2 \vdash \Delta_2$}
		
		\BinaryInfC{$\oc\Gamma_1, \Gamma_2 \vdash \wn\Delta_1, \Delta_2$}
		\DisplayProof
		...
		\noLine
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$\oc A, \oc A, \Gamma_2 \vdash \Delta_2$}
		\RightLabel{$\oc_C$}
		\UnaryInfC{$\oc A, \Gamma_2 \vdash \Delta_2$}
		...
		\BinaryInfC{$\oc\Gamma_1, \oc A, \Gamma_2 \vdash \wn \Delta_1, \Delta_2 $}
		
		\BinaryInfC{$\oc\Gamma_1, \oc\Gamma_1, \Gamma_2 \vdash \wn\Delta_1, \wn\Delta_1, \Delta_2 $}
		
		\doubleLine
		\RightLabel{ex.L, ex.R, $\oc_C$ and $\wn_C$}
		\UnaryInfC{$\oc\Gamma_1, \Gamma_2 \vdash \wn\Delta_1, \Delta_2$}
		\DisplayProof
		}
		...
		\UnaryInfC{$\Gamma_2 \vdash \Delta_2$}
		\doubleLine
		\RightLabel{$\oc_W$, $\wn_W$}
		\UnaryInfC{$\oc\Gamma_1, \Gamma_2 \vdash \wn\Delta_1, \Delta_2$}
		\DisplayProof
	\end{tabularx}
	
	
	\subsubsection{Secondary conclusion}
	...
	\begin{tabularx}{\textwidth}{x c x}
		\scalebox{0.7}{
			...
			\noLine
			\UnaryInfC{$\vdots$}
			\UnaryInfC{$\Gamma_2, B \vdash \Delta_2, C $}
			
			\RightLabel{$\parr_L$}
			\BinaryInfC{$\Gamma_1, A \parr B, \Gamma_2 \vdash \Delta_1, \Delta_2, C $}
			
			\AxiomC{$\pi_3$}
			\noLine
			\UnaryInfC{$\vdots$}
			\UnaryInfC{$C, \Gamma_3 \vdash \Delta_3$}
			
			\BinaryInfC{$\Gamma_1, A \parr B, \Gamma_2, \Gamma_3 \vdash \Delta_1, \Delta_2, \Delta_3 $}
			\DisplayProof
		}
		&
		$\rightsquigarrow$
		...
		\scalebox{0.7}{
			...
			\BinaryInfC{$\Gamma_2, B, \Gamma_3 \vdash \Delta_2, \Delta_3 $}
		...
		\noLine
		\UnaryInfC{$\vdots$}
		\UnaryInfC{$\Psi_1 \vdash \Psi_2, A $}
		\RightLabel{$r$}
		\UnaryInfC{$\Phi \vdash \Phi_2, A $}
		...
		\RightLabel{Cut}
		\BinaryInfC{$\Phi_1, \Gamma \vdash \Phi_2, \Delta $}
		\DisplayProof
		&
		$\rightsquigarrow$
		&
		...
		\RightLabel{Cut}
		\BinaryInfC{$\Psi_1, \Gamma \vdash \Psi_2, \Delta $}
		
		\RightLabel{$r$}
		\UnaryInfC{$\Phi_1, \Gamma \vdash \Phi_2, \Delta $}
		\DisplayProof
	\end{tabularx}
	
	Where $r$ is one of the following rules: $\oc_C, \oc_D, \oc_W, \oc_R, \wn_C, \wn_D, \wn_W, \wn_L, \otimes_L, \parr_R, 1_L, \bot_R$
